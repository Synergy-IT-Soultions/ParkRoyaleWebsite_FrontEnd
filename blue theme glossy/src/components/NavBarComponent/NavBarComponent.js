                ...
                <div className="container d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navbar" className="navbar" ref={this.navBarRef}>
                        <ul>
                            ...
                            <li><NavLink className='nav-link scrollto colorlink' to="/suitsandrooms" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Suits and Rooms</NavLink></li>
                            <li><NavLink className="nav-link scrollto colorlink" to="/restaurants" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Restaurants</NavLink></li>
                            <li><NavLink className="nav-link scrollto colorlink" to="/recreations" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Recreations</NavLink></li>
                            <li><NavLink className="nav-link scrollto colorlink" to="/toursandtravels" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Tours and Travels</NavLink></li>
                            <li><NavLink className="nav-link scrollto colorlink" to="/gallery" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Gallery</NavLink></li>
                            <li><NavLink className="nav-link scrollto colorlink" to="/contactus" activeclassname="active" onClick={this.closeMobileToggleDropDown}>Contact Us</NavLink></li>
