            ...
            <section id="pricing" className="pricing section-bg">
                <div className="container" data-aos="fade-up">
                    <div className="section-title">
                        ...
                        <h2 style={{color:'white'}}>{isAdmin && headerData ? <ContainerEditComponent showEditPage={ this.state.showEditPage} data={headerData} handleSave={this.handleSaveHeaderData} /> : ""}{containerHeader}</h2>
